<?php
/**
 * Easy Announcements Settings Page
 */
		...
		<div class="sub-fields">
			<div class="sub-field">
				...
				<?php printf(
					...
					Easy_Announcements_Utils::get_default_color( 'background', 'primary' ),
					isset( $this->options['background_color_primary'] ) ? esc_attr( $this->options['background_color_primary'] ) : Easy_Announcements_Utils::get_default_color( 'background', 'primary' )
				); ?>
			</div>
			<div class="sub-field">
				...
				<?php printf(
					...
					Easy_Announcements_Utils::get_default_color( 'background', 'secondary' ),
					isset( $this->options['background_color_secondary'] ) ? esc_attr( $this->options['background_color_secondary'] ) : Easy_Announcements_Utils::get_default_color( 'background', 'secondary' )
				); ?>
			</div>
			<div class="sub-field">
				...
				<?php printf(
					...
					Easy_Announcements_Utils::get_default_color( 'background', 'success' ),
					isset( $this->options['background_color_success'] ) ? esc_attr( $this->options['background_color_success'] ) : Easy_Announcements_Utils::get_default_color( 'background', 'success' )
				); ?>
			</div>
			<div class="sub-field">
				...
				<?php printf(
					...
					Easy_Announcements_Utils::get_default_color( 'background', 'danger' ),
					isset( $this->options['background_color_danger'] ) ? esc_attr( $this->options['background_color_danger'] ) : Easy_Announcements_Utils::get_default_color( 'background', 'danger' )
				); ?>
			</div>
			<div class="sub-field">
				...
				<?php printf(
					...
					Easy_Announcements_Utils::get_default_color( 'background', 'warning' ),
					isset( $this->options['background_color_warning'] ) ? esc_attr( $this->options['background_color_warning'] ) : Easy_Announcements_Utils::get_default_color( 'background', 'warning' )
				); ?>
			</div>
			<div class="sub-field">
				...
				<?php printf(
					...
					Easy_Announcements_Utils::get_default_color( 'background', 'info' ),
					isset( $this->options['background_color_info'] ) ? esc_attr( $this->options['background_color_info'] ) : Easy_Announcements_Utils::get_default_color( 'background', 'info' )
				); ?>
			</div>
		</div>
		<?php
		...
		<div class="sub-fields">
			<div class="sub-field">
				...
				<?php printf(
					...
					Easy_Announcements_Utils::get_default_color( 'content', 'primary' ),
					isset( $this->options['content_color_primary'] ) ? esc_attr( $this->options['content_color_primary'] ) : Easy_Announcements_Utils::get_default_color( 'content', 'primary' )
				); ?>
			</div>
			<div class="sub-field">
				...
				<?php printf(
					...
					Easy_Announcements_Utils::get_default_color( 'content', 'secondary' ),
					isset( $this->options['content_color_secondary'] ) ? esc_attr( $this->options['content_color_secondary'] ) : Easy_Announcements_Utils::get_default_color( 'content', 'secondary' )
				); ?>
			</div>
			<div class="sub-field">
				...
				<?php printf(
					...
					Easy_Announcements_Utils::get_default_color( 'content', 'success' ),
					isset( $this->options['content_color_success'] ) ? esc_attr( $this->options['content_color_success'] ) : Easy_Announcements_Utils::get_default_color( 'content', 'success' )
				); ?>
			</div>
			<div class="sub-field">
				...
				<?php printf(
					...
					Easy_Announcements_Utils::get_default_color( 'content', 'danger' ),
					isset( $this->options['content_color_danger'] ) ? esc_attr( $this->options['content_color_danger'] ) : Easy_Announcements_Utils::get_default_color( 'content', 'danger' )
				); ?>
			</div>
			<div class="sub-field">
				...
				<?php printf(
					...
					Easy_Announcements_Utils::get_default_color( 'content', 'warning' ),
					isset( $this->options['content_color_warning'] ) ? esc_attr( $this->options['content_color_warning'] ) : Easy_Announcements_Utils::get_default_color( 'content', 'warning' )
				); ?>
			</div>
			<div class="sub-field">
				...
				<?php printf(
					...
					Easy_Announcements_Utils::get_default_color( 'content', 'info' ),
					isset( $this->options['content_color_info'] ) ? esc_attr( $this->options['content_color_info'] ) : Easy_Announcements_Utils::get_default_color( 'content', 'info' )
				); ?>
			</div>
		</div>
		<?php
 ...
 */
if ( is_admin() ) {
	new Easy_Announcements_Settings();
}

// For old code that referenced easy_announcements_setting()
if ( ! function_exists( 'easy_announcements_setting' ) ) {
